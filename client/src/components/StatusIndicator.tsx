...
export default function StatusIndicator({ isScanning, scanCount, breakoutCount = 0, currentPair }: StatusIndicatorProps) {
  return (
    <Card className="fixed top-20 left-1/2 -translate-x-1/2 bg-trading-card border-trading-border rounded-lg p-3 shadow-lg z-50 pl-[12px] pr-[12px] ml-[150px] mr-[150px]">
